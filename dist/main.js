...
const productRepo = new ProductRepository_js_1.ProductRepository();
const categoryRepo = new CategoryRepository_js_1.CategoryRepository();
const userRepo = new UserRepository_js_1.UserRepository();
// ================= TEST FIND ALL =================
console.log("\n================= FIND ALL PRODUCTS =================\n");
...
try {
    ...
    if (err instanceof AppError_js_1.NotFoundError) {
